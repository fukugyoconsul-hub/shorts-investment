...
// 各キャラの利用規約(エンジンのspeaker_infoと各公式規約ページ原文)を確認した声のみ入れること。
// ずんだもん・四国めたん・九州そらは規約に「情報商材での利用・宣伝目的の利用NG」があるが、
// 本チャンネルは情報商材の宣伝目的ではないという運営者の判断で採用している(2026-09-21)。
// 青山龍星は企業が関わる利用に事前確認が必要なため除外。春日部つむぎ・波音リツ・剣崎雌雄は
// 規約本文を確認できていないため除外。
const VOICE_POOL = ["玄野武宏", "白上虎太郎", "雨晴はう", "冥鳴ひまり", "ずんだもん", "四国めたん", "九州そら"];
